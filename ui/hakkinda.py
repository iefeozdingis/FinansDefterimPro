...
class HakkindaSayfasi(ctk.CTkFrame):
    def __init__(self, parent, db, dashboard_callback=None):
        ...
        # Logo
        ctk.CTkLabel(
            kart, text="�", font=("Segoe UI Emoji", 60)
        ).pack(pady=(30, 5))

        ctk.CTkLabel(
            kart, text="Fineding",
            font=("Segoe UI", 28, "bold"), text_color="#5eead4"
        ).pack()
        ...
        # Ayraç
        ctk.CTkFrame(kart, height=1, fg_color="#334155").pack(fill="x", padx=80, pady=10)
        ...
        ctk.CTkLabel(
            ...
            font=("Segoe UI", 14), text_color="#cbd5e1", justify="center"
        ).pack(pady=(10, 5))

        # Özellikler
        ctk.CTkLabel(
            kart, text="✨ Özellikler",
            font=("Segoe UI", 17, "bold"), text_color="#2dd4bf"
        ).pack(pady=(20, 8))
        ...
        for ozellik in ozellikler:
            ctk.CTkLabel(
                kart, text=f"  • {ozellik}",
                font=("Segoe UI", 13), text_color="#94a3b8", anchor="w"
            ).pack(pady=2)

        # Ayraç
        ctk.CTkFrame(kart, height=1, fg_color="#334155").pack(fill="x", padx=80, pady=15)

        # Teknoloji
        ctk.CTkLabel(
            kart, text="🛠️ Teknolojiler",
            font=("Segoe UI", 15, "bold"), text_color="#a78bfa"
        ).pack(pady=(5, 5))
